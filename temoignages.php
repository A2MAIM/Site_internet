...
<div id="container">
	...
	<div id="main">
		...
		<?php include("alexandra_christophe.php") ?>
		<?php include("francois_mckee.php") ?>
		<?php include("alban_carraz.php") ?>
		<?php include("eve_lecoeur.php") ?>
		<?php include("kevin_charpentier.php") ?>
		<?php include("jacques_fontaine.php") ?>
		<?php include("jeremie_tache.php") ?>
		<?php include("david_guyot.php") ?>
